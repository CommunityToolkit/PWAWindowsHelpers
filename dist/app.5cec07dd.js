...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"src/utils.ts":[function(require,module,exports) {
"use strict";
...
function createSecondaryTile(tileId, options) {
  ...
  try {
    tile = new Windows.UI.StartScreen.SecondaryTile(tileId, options.title, options.title, options.activationArguments, newTileDesiredSize, logoUri); // Include any tile properties here v
    //Title text color
...
function removeSecondaryTile(tileId) {
  ...
  if (element) {
    ...
    var placement = Windows.UI.Popups.Placement.above;
    var tileToBeDeleted = new Windows.UI.StartScreen.SecondaryTile(tileId); // Make the delete request.
...
function updateSecondaryTile(tileId, options) {
  if (Windows.UI.StartScreen.SecondaryTile.exists(tileId)) {
    var tileToBeUpdated = new Windows.UI.StartScreen.SecondaryTile(tileId); // Background Color Update Code:
...
function toggleCompactOverlayMode(forceCompactOverlay) {
  if (forceCompactOverlay === void 0) {
    forceCompactOverlay = false;
  }

  if (!window.window) return Promise.resolve("unsupported");
  var applicationView = Windows.UI.ViewManagement.ApplicationView;
  var currentMode = applicationView.getForCurrentView().viewMode; //console.log(applicationView.getForCurrentView());

  var newMode = currentMode == Windows.UI.ViewManagement.ApplicationViewMode.default || forceCompactOverlay ? Windows.UI.ViewManagement.ApplicationViewMode.compactOverlay : Windows.UI.ViewManagement.ApplicationViewMode.default;
  console.log("newMode: ", newMode);
  console.log("currentMode: ", currentMode);
  console.log("Compact Mode Toggled");
  return applicationView.getForCurrentView().tryEnterViewModeAsync(newMode).then(function () {
    return newMode;
  });
}
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , Windows.Storage.StorageFile.getFileFromApplicationUriAsync(new Windows.Foundation.Uri("ms-appx:///images/Square150x150Logo.png"))];
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , originalBg.copyAsync(Windows.Storage.ApplicationData.current.localFolder, newName, 1)];
        ...
        case 2:
          ...
          return [4
          /*yield*/
          , Windows.Storage.ApplicationData.current.localFolder.getFileAsync(newName)];

        case 3:
          localBg = _a.sent(); // 3. Set as desktop bg image

          return [4
          /*yield*/
          , profileSettings.trySetWallpaperImageAsync(localBg)];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , channel.getOrCreateUserActivityAsync(options.id)];
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"src/app.ts":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/app.5cec07dd.map